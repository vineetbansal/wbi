...
function varargout = alignment_guiNew(varargin)
...
[dat_images,avi1_images]=ExtractAlignmentImagesFromVideoNew(imFolder);
avi0_images=avi1_images;
...
backgroundImage=uipickfiles('FilterSpec',backgroundLocation,...
    'Prompt','Select Background HiMag Image File3');
