function tracks = trackJN(xyzs,maxdisp,param)
...
%                     end
            ...
            ntrack = length(wh);
            if ntrack == 0 
                warning('Track:noTracks','There are no valid particles to track');
                break
            end
            xmat = zeros(ntrack,m);
            count = 0;
...
% Xinwei add if at line 1153 to prevent badsubscript.
