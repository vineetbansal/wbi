...
function fiducialCropper3_test(dataFolder)
%%%%%%%%%%%
...
% unique points 0-- thsi fixes issues after duplicate frame indices
[ft, index] = unique(hiResData.frameTime);
ethoTrack=interp1(ft,ethogram(index),hasPointsTime,'nearest');
...
xPos=xPosStage+orientationX*hiResCLposition(:,1);
