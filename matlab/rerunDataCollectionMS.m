...
copyfile([dataFolder filesep 'heatData.mat'], [dataFolder filesep 'heatDataMS.mat'])
save([dataFolder filesep 'heatDataMS.mat'],...
    'XYZcoord',...
    'behavior',...
    'hasPointsTime',...
    'clTime',...
...
alpha= (windsize-1)/(2*sdev); %from the matlab function definition
...
%     coord = zeros(foundNeurons, 3);
%     coord(trackIdx, :) = coord;
